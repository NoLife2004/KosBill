  ...
  routes: {
    ...
    images: route({
      ...
      onBeforeUpload: async () => {
        ...
        return {
          generateObjectInfo: (data: any) => ({
            key: `projects/ueWNpgre_wNnQJF1GQ1my/uploads/${uploadId}-${data.file.name}`,
          }),
        } as any;
      },
    }),
    ...
    avatar: route({
      ...
      onBeforeUpload: async () => {
        ...
        return {
          generateObjectInfo: (data: any) => ({
            key: `projects/ueWNpgre_wNnQJF1GQ1my/avatars/${uploadId}-${data.file.name}`,
          }),
        } as any;
      },
    }),
    ...
    documents: route({
      ...
      onBeforeUpload: async () => {
        ...
        return {
          generateObjectInfo: (data: any) => ({
            key: `projects/ueWNpgre_wNnQJF1GQ1my/documents/${uploadId}-${data.file.name}`,
          }),
        } as any;
      },
    }),
